...
import { PAGE_BG_SLATE, TEXT_MUTED_ON_SLATE, TEXT_ON_SLATE, CARD_WHITE } from "@/lib/theme/app-shell";
...
export default function ProfilePageClient() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg =
        e2 instanceof ApiError && e2.response.data && typeof e2.response.data === "object" && "error" in e2.response.data
          ? String((e2.response.data as { error: string }).error)
  ...
  const labelStyle: React.CSSProperties = { display: "block", fontWeight: 700, fontSize: 13, color: navy, marginBottom: 6 };
