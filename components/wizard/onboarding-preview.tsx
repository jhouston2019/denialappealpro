...
export default function OnboardingPreview() {
  ...
  const appealId =
    typeof params.appealId === 'string' ? params.appealId : params.appealId?.[0] ?? '';
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        <Link href="/start" style={{ color: TEXT_ON_SLATE, fontWeight: 600, textDecoration: 'none', fontSize: 15 }}>
          ← Edit details
        </Link>
