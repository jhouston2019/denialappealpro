...
/** Ported from frontend/src/pages/TermsOfService.js */
  ...
  return (
    <div style={{ maxWidth: "900px", margin: "0 auto", padding: "40px 20px" }}>
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        <p>
          By accessing and using Denial Appeal Pro (&quot;Service&quot;), you accept and agree to be bound by
          the terms and provision of this agreement. If you do not agree to these Terms of Service, please do
          not use the Service.
        </p>
      </section>
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        <p>
          Denial Appeal Pro is a software tool that generates template appeal letters for insurance claim
          denials. The Service provides document templates and formatting assistance only.
        </p>
        <p
          style={{
            background: "#fff3cd",
        ...
        >
          ...
          healthcare services. The templates generated are for informational purposes only and must be
          reviewed, modified, and approved by qualified healthcare professionals before submission.
        </p>
      </section>
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        <ul style={{ lineHeight: "1.8" }}>
          <li>
            You are a licensed healthcare provider or authorized representative with the legal right to
            submit insurance appeals on behalf of patients.
          </li>
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        <p>
          ...
          material changes by posting the new Terms of Service on this page and updating the &quot;Last
          Updated&quot; date. Your continued use of the Service after any changes constitutes acceptance of
          the new terms.
        </p>
      </section>
