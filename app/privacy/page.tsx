...
/** Ported from frontend/src/pages/PrivacyPolicy.js */
  ...
  return (
    <div style={{ maxWidth: "900px", margin: "0 auto", padding: "40px 20px" }}>
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        <p>
          Denial Appeal Pro (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting your privacy. This
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        <ul style={{ lineHeight: "1.8" }}>
          <li>
            <strong>Provider Information:</strong> Provider name, NPI number, contact information
          </li>
          <li>
            <strong>Patient Information:</strong> Patient ID (de-identified), date of service
          </li>
          <li>
            <strong>Claim Information:</strong> Payer name, claim number, denial reason, denial code, CPT codes
          </li>
          <li>
            <strong>Payment Information:</strong> Processed securely through Stripe (we do not store credit card
            numbers)
          </li>
          <li>
            <strong>Uploaded Documents:</strong> Denial letters or supporting documentation you choose to upload
          </li>
        </ul>
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        <p>
          If you are a covered entity under HIPAA, we can execute a Business Associate Agreement (BAA) with
          you. Please contact us to request a BAA.
        </p>
        <p>
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        <p>We retain your information for as long as necessary to provide the Service and comply with legal
          obligations:</p>
        <ul style={{ lineHeight: "1.8" }}>
          <li>
            <strong>Appeal Data:</strong> Retained for 7 years to comply with healthcare record retention
            requirements
          </li>
          <li>
            <strong>Payment Records:</strong> Retained for 7 years for tax and accounting purposes
          </li>
          <li>
            <strong>Uploaded Documents:</strong> Deleted after 90 days unless otherwise specified
          </li>
          <li>
            <strong>Usage Data:</strong> Retained for 2 years for analytics and service improvement
          </li>
        </ul>
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        <ul style={{ lineHeight: "1.8" }}>
          ...
          <li>
            <strong>Hosting Providers:</strong> Data storage and application hosting
          </li>
          <li>
            <strong>Analytics Services:</strong> Service improvement and usage analysis
          </li>
        </ul>
        <p>
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        <p>
          ...
          practices of these websites. We encourage you to read the privacy policies of any third-party sites
          you visit.
        </p>
      </section>
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        <div style={{ background: "#f8f9fa", padding: "20px", borderRadius: "8px", marginTop: "15px" }}>
          <p style={{ margin: "5px 0" }}>
            <strong>Email:</strong> privacy@denialappealpro.com
          </p>
          <p style={{ margin: "5px 0" }}>
